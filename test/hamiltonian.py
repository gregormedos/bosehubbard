...
def test_decomposition_n(num: int):
    ...
    fig, axes = plt.subplots(1, len(hs.subspaces), figsize=(len(hs.subspaces) * 5, 5))
    for axis in axes.flat:
        axis.set_xticks([])
        axis.set_yticks([])
        axis.set_xticklabels([])
...
def test_decomposition_kn(num: int):
    ...
    fig, axes = plt.subplots(5, len(hs.subspaces), figsize=(len(hs.subspaces) * 5, 5 * 5))
    for axis in axes.flat:
        axis.set_xticks([])
        axis.set_yticks([])
        axis.set_xticklabels([])
...
def test_kblock(num: int):
    # TODO: KN -> PKN instead of K -> KN -> PKN
    fig, axes = plt.subplots(2, 4, figsize=(10, 5))
    for axis in axes.flat:
        axis.set_xticks([])
        axis.set_yticks([])
